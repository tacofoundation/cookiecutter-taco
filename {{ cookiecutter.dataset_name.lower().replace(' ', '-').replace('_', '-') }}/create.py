...
def main():
    ...
    2. Build TACO object
    3. Write to disk with create()
    4. Auto-consolidate to .tacocat/ if multiple ZIPs (if enabled)
    5. Generate documentation (if enabled)
    """
    ...
    if tacocat_path.exists():
        ...
        print(f"Consolidated metadata in {tacocat_path}")
    else:
        # Single file - generate COLLECTION.json in parent dir
        print(f"Generating COLLECTION.json in {parent_dir}")
